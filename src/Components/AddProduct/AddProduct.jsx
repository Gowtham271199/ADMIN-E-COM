...
const AddProduct = () => {
    ...
    const Add_Product =async ()=>{
        ...
        await fetch('https://be-e-com.onrender.com/upload',{
            method:'POST',
            headers:{
            ...
            if(responseData.success){
                ...
                console.log(product)
                await fetch('https://be-e-com.onrender.com/addproduct',{
                method:'POST',
                headers:{
                Accept:'application/json',
  ...
  return (
    <div className='add-product'>
        ...
        <div className="addproduct-itemfield">
            ...
            <img src={image?URL.createObjectURL(image): upload_area } alt='uploadarea' className='upload-thumbnail-img'></img>
            </label>
